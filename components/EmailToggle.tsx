...
import { updateEmailNotifications } from '@/app/actions/profile'

export default function EmailToggle({ initialValue }: { initialValue: boolean }) {
  ...
  return (
    <button
      onClick={toggle}
      disabled={busy}
      aria-label={on ? 'Disable email notifications' : 'Enable email notifications'}
